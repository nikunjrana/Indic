This project is created by Pushpendra - 33501 using  [Create React App](https://github.com/facebookincubator/create-react-app).
This is Baseline code  for Progressive Web App against Indiamart.

Original name for this project is "im-lite" only.
If you want to make this project run, follwing are the steps:

1. Remove password from this dev-m.indiamart.com
2. Redirection from url "dev-m.indiamart.com/products" should be to folder "im-lite/build", you can use follwing command:
 if ($_SERVER['SCRIPT_URL'] == '/products/' || $_SERVER['SCRIPT_URL']=='im-lite/build/' ) {
    include 'im-lite/build/index.html';
    exit;
  }
